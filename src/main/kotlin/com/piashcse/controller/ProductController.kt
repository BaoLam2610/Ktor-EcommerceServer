...
class ProductController {
    suspend fun addProduct(userId: String, addProduct: AddProduct, fileName: String) = query {
        ProductEntity.new {
    ...
    suspend fun getProduct(
        productQuery: ProductWithFilter,
        ...
        onReturnPage.invoke(
            getPageResult(query, productQuery.pageSize, productQuery.currentPage)
        )
        query.limit(productQuery.pageSize, productQuery.offset).map {
